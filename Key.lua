...
local Config = {
    ...
    ServiceId       = 28016, -- Your PlatoBoost Service ID
    PlatoSecret     = "d873259b-017a-4511-b5a7-b6be395b6c34", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "saturnus", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/itsvanna-ai/Saturnium/refs/heads/main/Saturnium.lua", -- The raw URL of your main script
    ...
    -- [6] GUI Management
    OldGuiName      = "Saturnium", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "Saturnium", -- Name of the main script's GUI to check if it's already executing
